...
export function Instances({ children, ...props }) {
  const { nodes } = useGLTF('%PUBLIC_URL%/computers_1-transformed.glb')
...
export function Computers(props) {
  const { nodes: n, materials: m } = useGLTF('%PUBLIC_URL%/computers_1-transformed.glb')
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <ScreenGIF frame="Object_209" panel="Object_210" y={5} position={[-1.43, 2.5, -1.8]} rotation={[0, 1, 0]} />
      <ScreenGIF invert frame="Object_212" panel="Object_213" x={-5} y={5} position={[-2.73, 0.63, -0.52]} rotation={[0, 1.09, 0]} />
      <ScreenGIF invert frame="Object_215" panel="Object_216" position={[1.84, 0.38, -1.77]} rotation={[0, -Math.PI / 9, 0]} />
      <ScreenGIF invert frame="Object_218" panel="Object_219" x={-5} position={[3.11, 2.15, -0.18]} rotation={[0, -0.79, 0]} scale={0.81} />
      <ScreenGIF frame="Object_221" panel="Object_222" y={5} position={[-3.42, 3.06, 1.3]} rotation={[0, 1.22, 0]} scale={0.9} />
      <ScreenGIF invert frame="Object_224" panel="Object_225" position={[-3.9, 4.29, -2.64]} rotation={[0, 0.54, 0]} />
      <ScreenGIF frame="Object_227" panel="Object_228" position={[0.96, 4.28, -4.2]} rotation={[0, -0.65, 0]} />
      <ScreenGIF frame="Object_230" panel="Object_231" position={[4.68, 4.29, -1.56]} rotation={[0, -Math.PI / 3, 0]} />
...
function Screen({ frame, panel, children, ...props }) {
  const { nodes, materials } = useGLTF('%PUBLIC_URL%/computers_1-transformed.glb')
  return (
    <group {...props}>
...
function ScreenGIF({ invert, x = 0, y = 0, imageUrl, ...props }) {
  ...
  return (
    <Screen {...props}>
      ...
      <color attach="background" args={[invert ? 'black' : 'red']} />
      <ambientLight intensity={0.5} />
      <directionalLight position={[10, 10, 5]} />
      <mesh ref={imgRef} position={[x, y, 0]}>
...
//       <ambientLight intensity={0.5} />
//       <directionalLight position={[10, 10, 5]} />
//       <Text font="/Inter-Medium.woff" position={[x, y, 0]} ref={textRef} fontSize={4} letterSpacing={-0.1} color={!invert ? 'black' : 'red'}>
//         Surveillance
//       </Text>
//     </Screen>
//   )
...
function Leds({ instances }) {
  ...
  useFrame((state) => {
    ref.current.children.forEach((instance) => {
      ...
      instance.color.setRGB(t*1.1, 0, 0)
    })
  })
  return (
    <group ref={ref}>
      <instances.Sphere position={[-0.41, 1.1, -2.21]} scale={0.05} color={[1, 0, 0]} />
      <instances.Sphere position={[0.59, 1.32, -2.22]} scale={0.05} color={[1, 0, 0]}  />
      <instances.Sphere position={[1.77, 1.91, -1.17]} scale={0.05} color={[1, 0, 0]}  />
      <instances.Sphere position={[2.44, 1.1, -0.79]} scale={0.05} color={[1, 0, 0]}  />
      <instances.Sphere position={[4.87, 3.8, -0.1]} scale={0.05} color={[1, 0, 0]}  />
      <instances.Sphere position={[1.93, 3.8, -3.69]} scale={0.05} color={[1, 0, 0]}  />
      <instances.Sphere position={[-2.35, 3.8, -3.48]} scale={0.05} color={[1, 0, 0]}  />
      <instances.Sphere position={[-4.71, 4.59, -1.81]} scale={0.05} color={[1, 0, 0]}  />
      <instances.Sphere position={[-3.03, 2.85, 1.19]} scale={0.05} color={[1, 0, 0]}  />
      <instances.Sphere position={[-1.21, 1.73, -1.49]} scale={0.005} color={[1, 0, 0]}  />
    </group>
  )
}
